...
export const translations = {
  en: {
    ...
    intakeFieldHelp: {
      ...
      businessSize: 'Use the EU business-size band that best matches the enterprise today, including mid-caps or larger firms if relevant.',
    ...
    labels: {
      ...
      businessSize: 'Business Size (EU enterprise size band)',
    ...
    businessSizes: {
      ...
      midCap: 'Mid-cap: 250 to 2,999 employees',
      large: 'Large: 3,000+ employees or a broader large-enterprise profile',
    },
    agricultureSubTypes: {
  ...
  es: {
    ...
    labels: {
      ...
      businessSize: 'Tamaño de la empresa (tramo de tamaño empresarial UE)',
    ...
    businessSizes: {
      ...
      midCap: 'Mid-cap: entre 250 y 2.999 empleados',
      large: 'Grande: 3.000 empleados o más, o un perfil de gran empresa',
    },
    agricultureSubTypes: {
  ...
  it: {
    ...
    labels: {
      ...
      businessSize: 'Dimensione dell’impresa (fascia dimensionale UE)',
    ...
    businessSizes: {
      ...
      midCap: 'Mid-cap: da 250 a 2.999 dipendenti',
      large: 'Grande: 3.000 o più dipendenti, o profilo da grande impresa',
    },
    agricultureSubTypes: {
  ...
  pl: {
    ...
    labels: {
      ...
      businessSize: 'Wielkość firmy (unijna kategoria wielkości przedsiębiorstwa)',
    ...
    businessSizes: {
      ...
      midCap: 'Mid-cap: od 250 do 2 999 pracowników',
      large: 'Duża: 3 000+ pracowników lub profil dużego przedsiębiorstwa',
    },
    agricultureSubTypes: {
  ...
  fr: {
    ...
    labels: {
      ...
      businessSize: 'Taille de l’entreprise (catégorie de taille d’entreprise UE)',
    ...
    businessSizes: {
      ...
      midCap: 'Mid-cap : de 250 à 2 999 salariés',
      large: 'Grande : 3 000 salariés ou plus, ou profil de grande entreprise',
    },
    agricultureSubTypes: {
